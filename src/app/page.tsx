    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'glass-cream shadow-[0_4px_24px_rgba(61,28,2,0.1)] py-2' : 'bg-transparent py-4'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <select className={`text-xs px-3 py-1.5 rounded-lg border transition-all focus:outline-none ${scrolled ? 'bg-white border-[#3D1C02]/15 text-[#3D1C02]' : 'bg-white/10 border-white/20 text-white'}`}>
          ...
          <Link href="/registro" className="text-sm font-semibold bg-[#C84B2F] text-white px-4 py-2 rounded-xl hover:bg-[#A83A22] transition-all hover:shadow-lg hover:scale-105">Registrarse</Link>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden glass-cream border-t border-[#3D1C02]/10 px-4 py-4 flex flex-col gap-3">
          ...
          <div className="flex gap-2 pt-2 border-t border-[#3D1C02]/10">
            ...
            <Link href="/registro" className="flex-1 text-center text-sm font-semibold bg-[#C84B2F] text-white py-2 rounded-xl hover:bg-[#A83A22] transition-colors">Registrarse</Link>
          </div>
        </div>
      )}
    </nav>
  ...
  return (
    <>
      ...
      <div className={`transition-opacity duration-700 ${loading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        {/* HERO */}
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden text-white px-4"
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-tight min-h-[1.2em]" style={{ fontFamily: 'serif' }}>
              <Typewriter text="Bienvenido a Kuska" delay={60} className="gradient-text"
            ...
            <div className={`transition-all duration-700 ${subtitleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                <Link href="/registro" className="group relative w-full sm:w-auto px-8 py-4 bg-[#C84B2F] text-white font-bold rounded-2xl hover:bg-[#A83A22] transition-all hover:scale-105 hover:shadow-2xl text-base overflow-hidden">
                ...
                <Link href="/registro" className="w-full sm:w-auto px-8 py-4 text-white font-bold rounded-2xl transition-all hover:scale-105 text-base border border-white/20" style={{ background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(12px)' }}>
                  🛍️ Soy cliente
                </Link>
              </div>
              <Link href="/marketplace" className="text-sm text-white/40 hover:text-white/70 transition-colors underline underline-offset-4">
              ...
              <Reveal delay={100}>
                <div data-hover className="group relative rounded-3xl p-8 overflow-hidden hover:shadow-[0_8px_40px_rgba(61,28,2,0.2)] transition-all duration-300 hover:-translate-y-1" style={{ background: 'linear-gradient(135deg, #3D1C02, #5a2d0c)' }}>
                  ...
                  <div className="relative">
                    ...
                    <Link href="/registro" className="inline-flex items-center gap-2 px-6 py-3 bg-[#C84B2F] text-white font-bold rounded-xl hover:bg-[#A83A22] transition-all hover:scale-105 text-sm">
              ...
              <Reveal delay={200}>
                <div data-hover className="group relative rounded-3xl p-8 overflow-hidden hover:shadow-[0_8px_40px_rgba(46,122,110,0.2)] transition-all duration-300 hover:-translate-y-1" style={{ background: 'linear-gradient(135deg, #2E7A6E, #1a5049)' }}>
                  ...
                  <div className="relative">
                    ...
                    <Link href="/registro" className="inline-flex items-center gap-2 px-6 py-3 bg-white/15 border border-white/30 text-white font-bold rounded-xl hover:bg-white/25 transition-all hover:scale-105 text-sm">
        ...
        <section className="py-24 px-4 text-white relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #1A0A00 0%, #3D1C02 100%)' }}>
          ...
          <Reveal>
            <div className="max-w-3xl mx-auto text-center relative">
              ...
              <p className="text-white/60 text-lg mb-10 max-w-xl mx-auto">Solo S/10 de inscripción para artesanos. Sin mensualidades.</p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/registro" className="group w-full sm:w-auto px-10 py-4 bg-[#C84B2F] hover:bg-[#A83A22] text-white font-bold rounded-2xl transition-all hover:scale-105 hover:shadow-2xl text-base overflow-hidden relative">
                  <span className="relative z-10">Registrarme ahora →</span>
                  <div className="absolute inset-0 shimmer-bg opacity-0 group-hover:opacity-100 transition-opacity" />
                </Link>
                <Link href="/marketplace" className="w-full sm:w-auto px-10 py-4 border border-white/20 text-white font-bold rounded-2xl hover:bg-white/10 transition-all hover:scale-105 text-base" style={{ backdropFilter: 'blur(12px)' }}>
                  Ver el marketplace
                </Link>
              </div>
            </div>
