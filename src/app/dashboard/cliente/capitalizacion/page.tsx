...
export default async function ClientCapitalizacionPage() {
  ...
  if (!session.user.is_entrepreneur) {
    return (
      <EntrepreneurGate
        title="El Hub de Capitalización es para emprendedores"
        description="Activa «¿Eres emprendedor?» desde tu perfil para ver y postular a fondos reales de financiamiento."
      />
    )
  }
  ...
  return (
    <div className="p-6 lg:p-10">
      <DashboardHero
        badge="💰 Hub de Capitalización"
        title="Fondos reales para hacer crecer tu idea"
        description="Convocatorias activas de instituciones que financian emprendimientos peruanos. Postula cuando tengas tu plan de negocio listo."
        kusiAnimation="wave"
      />
